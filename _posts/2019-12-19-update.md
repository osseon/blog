---
title: "Start many projects to be a data analyst"
sub_title: ""
categories:
  - Markup
elements:
...
I have been tried many times to practice Jekyll and Git
because my work is so personal and there's no drive to write public posts.

### Fix and update this blog
  - Add favicon on this blog: [instruction blog](https://medium.com/@xiang_zhou/how-to-add-a-favicon-to-your-jekyll-site-2ac2179cc2ed)
  - Make title of posts be narrower.


### Zsh manual translation project
  - Change to 2nd version of theme
  - Modify the top navigation design

### Machine learning self-education
  - Book: <q> Introduction to Machine Learning with Python</q>
    - Engaged with more to dos...
      - Which editor?: Atom or Jupytor notebook or Spyder?
      - Do I need to use Docker?: Study what is Docker
      - Install scikit-learn
  - Coursera: not decided
